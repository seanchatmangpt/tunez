...
# Use DATABASE_URL from environment if available, otherwise use defaults
...
config :tunez, dev_routes: true, token_signing_secret: "eibsTy3ZbNpeNaiSbZ7n8ChP/Du0Zt46"
